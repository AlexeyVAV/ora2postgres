...
-- Create DDL for - MARKETPLACE.AGGREGATE_FUNCTION_MATRIX                                                                                                                                                                                                                                                                                                                                                                                                                                                           
  ...
  ALTER TABLE "MARKETPLACE"."AGGREGATE_FUNCTION_MATRIX" ADD UNIQUE ("TABLE_NAME")
  USING INDEX  ENABLE                                                                                                                                                                                                                                              
-- -------------------------------------------------------                                                                                                                                                                                                                                                                                                                                                                                                                                                          
-- Create DDL for - MARKETPLACE.AGGREGATE_MATRIX                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
  ...
  ALTER TABLE "MARKETPLACE"."AGGREGATE_MATRIX" ADD CHECK (DIMENSION_YN IN ('Y','N','R')) ENABLE
  ALTER TABLE "MARKETPLACE"."AGGREGATE_MATRIX" ADD CONSTRAINT "AGGREGATE_MATRIX_FK" FOREIGN KEY ("TABLE_NAME")
...
-- Create DDL for - MARKETPLACE.APEX$_ACL                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
  ...
  ALTER TABLE "MARKETPLACE"."APEX$_ACL" ADD CONSTRAINT "APEX$_ACL_PRIV_CK" CHECK (priv in ('R','C','A')) ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_ACL" ADD         
...
VARCHAR2(4000), 
  ...
  ALTER TABLE "MARKETPLACE"."APEX$_WS_FILES" ADD CONSTRAINT "APEX$_WS_FILES_CL_CK" CHECK (component_level in ('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_FILES" ADD CONSTRAINT "APEX$_WS_FILES_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_FILES" ADD CONSTRAINT       
"APEX$_WS_FILES_FK" FOREIGN KEY ("ROW_ID")
...
-- Create DDL for - MARKETPLACE.APEX$_WS_LINKS                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
  ...
  ALTER TABLE "MARKETPLACE"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_CL_CK" CHECK (component_level in ('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_SH_CK" CHECK (show_on_homepage in ('Y','N')) ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE
  ALTER TABLE                        
"MARKETPLACE"."APEX$_WS_LINKS" ADD CONSTRAINT "APEX$_WS_LINKS_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "MARKETPLACE"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE                                                                                                                                                                                                                                                                                                                                                
-- -------------------------------------------------------                                                                                                                                                                                                                                                                                                                                                                                                                                                          
-- Create DDL for - MARKETPLACE.APEX$_WS_NOTES                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
  ...
  ALTER TABLE "MARKETPLACE"."APEX$_WS_NOTES" ADD CONSTRAINT "APEX$_WS_NOTES_CL_CK" CHECK (component_level in                              
('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_NOTES" ADD CONSTRAINT "APEX$_WS_NOTES_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_NOTES" ADD CONSTRAINT "APEX$_WS_NOTES_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "MARKETPLACE"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE                                                                                                                                                        
-- -------------------------------------------------------                                                                                                                                                                                                                                                                                                                                                                                                                                                          
...
DATE, 
  ...
  ALTER TABLE "MARKETPLACE"."APEX$_WS_ROWS" ADD CONSTRAINT "APEX$_WS_ROWS_PK" PRIMARY KEY ("ID")
  USING
INDEX  ENABLE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
-- -------------------------------------------------------                                                                                                                                                                                                                                                                                                                                                                                                                                                          
-- Create DDL for - MARKETPLACE.APEX$_WS_TAGS                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
  ...
  ALTER TABLE "MARKETPLACE"."APEX$_WS_TAGS" ADD CONSTRAINT "APEX$_WS_TAGS_CL_CK" CHECK (component_level in                           
('WEBSHEET','ROW','WORKSPACE','WEBPAGE')) ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_TAGS" ADD CONSTRAINT "APEX$_WS_TAGS_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE
  ALTER TABLE "MARKETPLACE"."APEX$_WS_TAGS" ADD CONSTRAINT "APEX$_WS_TAGS_FK" FOREIGN KEY ("ROW_ID")
	  REFERENCES "MARKETPLACE"."APEX$_WS_ROWS" ("ID") ON DELETE CASCADE ENABLE                                                                                                                                                            
-- -------------------------------------------------------                                                                                                                                                                                                                                                                                                                                                                                                                                                          
